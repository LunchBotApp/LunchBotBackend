 ...
 */
class LoadSuggestion implements FixtureInterface, ContainerAwareInterface
{
    /**
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $reportA = new CrawlerErrorReport($userA, 'The crawler is not working correctly');
